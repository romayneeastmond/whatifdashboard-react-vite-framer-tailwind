...
- **📊 Comprehensive Calculators**:
  ...
  - **Lower-Paying Job**: Side-by-side comparison of your current salary against a lower-paying job offer. Factors in tax rates, retirement contributions, benefits value, and monthly surplus to show the true financial cost of the pay cut, plus 5-year and 10-year projected wealth accumulation for each scenario.
  - **Severance & EI Estimator**: Estimate your Canadian severance package and Employment Insurance benefits after a job loss.
  - **FIRE / Retirement Calculator**: Find your FIRE number and project when you can retire. Models portfolio growth over time using current savings, monthly contributions, expected return, inflation, and safe withdrawal rate. Shows whether you're on track, the earliest possible retirement age if not, and the monthly savings needed to hit your target. Supports multiple profiles for couples planning together.
  - **Emergency Fund Runway**: Check whether your emergency fund is big enough and project how long it will take to build one. Shows current runway in months, coverage percentage against your target, gap to fill, and months to goal at current or aggressive contribution pace. Includes a savings projection chart and five what-if scenarios.
  - **Layoff Survival Simulator**: Model how long your savings and severance will last after a job loss.
  - **Net Worth Projection**: Track your complete net worth by entering all assets (cash, investments, real estate, vehicles, other) and liabilities (mortgage, car loans, student loans, credit cards, other debt). Projects growth over up to 40 years using monthly savings rate and annual growth rate. Shows debt-to-asset ratio, year net worth turns positive (if currently negative), and projected value. Supports multiple profiles for couples tracking net worth together.
  - **Total Compensation**: See the full value of a job offer beyond base salary. Toggle dental, medical, vision, life insurance, disability, and RRSP / 401k match benefits — each with an adjustable employer-cost slider. Shows total benefits value, total compensation, benefits as a percentage of salary, and estimated monthly take-home.
  - **RRSP vs TFSA Optimizer**: Compare RRSP-first and TFSA-first contribution strategies. Enter your current and expected retirement tax rates, balances, and annual contribution to see which account maximizes after-tax wealth at retirement. RRSP-first strategy assumes annual refunds are reinvested in TFSA. Supports multiple profiles for couples planning together. Enter funds, EI, side income, and expenses to see your runway in months, monthly burn rate, and break-even income needed. Includes a survival-mode scenario (30% variable expense cut) and five what-if toggles. Calculates ESA termination pay and severance pay by province, EI eligibility based on insurable hours and regional unemployment rate, weekly benefit amount, benefit duration, and your combined income runway.
...
- **📤 Import / Export**: Save and restore your entire dashboard state as a JSON file for backup or sharing. The Export menu offers five formats:
  ...
  - **📊 Excel (.xlsx)** — a multi-sheet workbook with one sheet per calculator. Multi-profile calculators (Salary, Mortgage, Investment, Debt, Goals, Time, FIRE, RRSP/TFSA) produce one row per profile; single-entity calculators produce a three-column Section / Field / Value table. Compatible with Excel, Google Sheets, and Numbers.
